...
<head>
  ...
  <title>WebDev Evaluation - Admin</title>
...
<body  style="background:#eee;">
  <div class="header">
    <div class="row">
      <div class="col-lg-6">
        ...
        if(!(isset($_SESSION['email']))){
          ...
          $name = $_SESSION['name'];;
          include_once 'dbConnection.php';
          echo '<span class="pull-right top title1" ><span class="log1"><span aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
        }
        ?>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            </li><li class="pull-right"><a href="logout.php?q=account.php"><span aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Signout</a></li>
          </ul>
        </div>
      </div>
    </nav>
    <!-- Stop Navigation elements -->
    <!-- Sart Home elements -->
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          ?>  
      <!-- Stop Home elements -->
      <!-- Start Users elements-->
      <?php 
      if(@$_GET['q']==1) {
        $result = mysqli_query($con,"SELECT * FROM user") or die('Error');
        echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
        <tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Company</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
        $c=1;
        while($row = mysqli_fetch_array($result)) {
	        $name = $row['name'];
	        $mob = $row['mob'];
          ...
          $email = $row['email'];
	        $company = $row['company'];
	        echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$company.'</td><td>'.$email.'</td><td>'.$mob.'</td>
	        <td><a title="Delete User" href="update.php?demail='.$email.'"><b><span aria-hidden="true"></span></b></a></td></tr>';
        }
        $c=0;
        echo '</table></div></div>';
      }
      ...
      if(@$_GET['q']==3) {
        ...
        $c=1;
          while($row = mysqli_fetch_array($result)) {
	          ...
	          <td><a title="Open Feedback" href="dash.php?q=3&fid='.$id.'"><b><span aria-hidden="true"></span></b></a></td>';
	          echo '<td><a title="Delete Feedback" href="update.php?fdid='.$id.'"><b><span aria-hidden="true"></span></b></a></td></tr>';
          }
          echo '</table></div></div>';
        }
      ?>
      <!--Stop Feedback elements-->
      <!--Start Feedback Reading Portion elements-->
      <?php 
      if(@$_GET['fid']) {
        echo '<br />';
        $id=@$_GET['fid'];
        ...
        while($row = mysqli_fetch_array($result)) {
          ...
          echo '<div class="panel"<a title="Back to Archive" href="update.php?q1=2"><b><span aria-hidden="true"></span></b></a><h2 style="text-align:center; margin-top:-15px;font-family: "Ubuntu", sans-serif;"><b>'.$subject.'</b></h1>';
          echo '<div class="mCustomScrollbar" data-mcs-theme="dark" style="margin-left:10px;margin-right:10px; max-height:450px; line-height:35px;padding:5px;"><span style="line-height:35px;padding:5px;">-&nbsp;<b>DATE:</b>&nbsp;'.$date.'</span>
          <span style="line-height:35px;padding:5px;">&nbsp;<b>Time:</b>&nbsp;'.$time.'</span><span style="line-height:35px;padding:5px;">&nbsp;<b>By:</b>&nbsp;'.$name.'</span><br />'.$feedback.'</div></div>';}
        }
      ?>
      <!--Stop Feedback Reading Portion elements-->
      <!--Start Quiz elements-->
      <?php
    ...
    ?>
    <!--Stop Quiz 2 elements-->
    <!--Start Remove Quiz elements-->
    <?php 
    if(@$_GET['q']==5) {
      $result = mysqli_query($con,"SELECT * FROM quiz ORDER BY date DESC") or die('Error');
      echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
